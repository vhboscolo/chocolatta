...
// ── Mock Apify / Google Maps scrape results ──────────────────────────────
export const mockScrapeResults: ApifyPlace[] = [
  {
    title: 'Supermercado Vila Nova',
    address: 'Rua dos Três Irmãos, 1204 - Vila Nova Conceição, São Paulo - SP, 04611-040',
    phone: '(11) 3842-5500',
    email: 'compras@supervilanova.com.br',
    lat: -23.5965,
    lng: -46.6663,
    totalScore: 4.3,
    reviewsCount: 812,
  ...
  {
    title: 'Padaria Forno de Minas - Perdizes',
    address: 'Rua Cardoso de Almeida, 788 - Perdizes, São Paulo - SP, 05013-001',
    phone: '(11) 3864-2211',
    email: undefined,
    lat: -23.5362,
    lng: -46.6684,
    totalScore: 4.6,
    reviewsCount: 1543,
    categories: ['Padaria', 'Confeitaria'],
  },
  {
    title: 'Mercadão do Tatuapé',
    address: 'Rua Melo Freire, 115 - Tatuapé, São Paulo - SP, 03305-030',
    phone: '(11) 2091-3300',
    email: 'contato@mercadaotatuape.com.br',
    lat: -23.5433,
    lng: -46.5767,
    totalScore: 4.1,
    reviewsCount: 378,
  ...
  {
    title: 'Confeitaria Amor em Pedaços - Moema',
    address: 'Av. Ibirapuera, 3103 - Moema, São Paulo - SP, 04029-200',
    phone: '(11) 5054-8899',
    email: 'moema@amorempedacos.com.br',
    lat: -23.6112,
    lng: -46.6710,
    totalScore: 4.8,
    reviewsCount: 2201,
    categories: ['Confeitaria'],
  },
  {
    title: 'Distribuidora São Marcos Alimentos',
    address: 'Rua Joinville, 340 - Brás, São Paulo - SP, 03026-010',
    phone: '(11) 3392-1100',
    email: 'vendas@saomarcosalim.com.br',
    lat: -23.5419,
    lng: -46.6131,
    totalScore: 3.9,
    reviewsCount: 145,
    categories: ['Distribuidora de alimentos'],
  },
  {
    title: 'Atacado FoodMax',
    address: 'Av. do Estado, 4550 - Brás, São Paulo - SP, 03102-000',
    phone: '(11) 3315-7788',
    email: undefined,
    lat: -23.5371,
    lng: -46.6197,
    totalScore: 4.0,
    reviewsCount: 289,
    categories: ['Atacadista de alimentos'],
  },
  {
    title: 'Cafeteria Grão Especial',
    address: 'Rua Oscar Freire, 540 - Jardins, São Paulo - SP, 01426-001',
    phone: '(11) 3062-4455',
    email: 'jardins@graoespecial.com.br',
    lat: -23.5606,
    lng: -46.6686,
    totalScore: 4.7,
    reviewsCount: 3411,
  ...
  {
    title: 'Mercaria do Bairro - Pinheiros',
    address: 'Rua Wisard, 480 - Vila Madalena, São Paulo - SP, 05434-080',
    phone: '(11) 3031-9900',
    email: undefined,
    lat: -23.5526,
    lng: -46.6897,
  ...
  {
    title: 'Padaria e Confeitaria Doce Encanto',
    address: 'Rua Vergueiro, 2876 - Vila Mariana, São Paulo - SP, 04102-001',
    phone: '(11) 5084-3322',
  ...
  {
    title: 'Empório Gourmet Santo André',
    address: 'Rua Coronel Oliveira Lima, 901 - Centro, Santo André - SP, 09020-230',
    phone: '(11) 4433-8800',
    email: 'comercial@emporiogourmet.com.br',
    lat: -23.6654,
    lng: -46.5393,
    totalScore: 4.2,
    reviewsCount: 413,
    categories: ['Mercado', 'Empório'],
  },
  {
    title: 'Supermercado Guanabara - Guarulhos',
    address: 'Av. Tiradentes, 2400 - Jardim Flor da Montanha, Guarulhos - SP, 07252-230',
    phone: '(11) 2473-9900',
    email: undefined,
    lat: -23.4543,
    lng: -46.5333,
  ...
  {
    title: 'Loja de Conveniência 24h BomPreço',
    ...
    totalScore: 3.6,
    reviewsCount: 1187,
    categories: ['Loja de conveniência'],
  },
]
